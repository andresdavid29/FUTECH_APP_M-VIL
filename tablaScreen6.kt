...
@Composable
fun TablaScreen6(viewModel: TablaViewModel6 = TablaViewModel6(LocalContext.current)) {
...
fun getFlagResource(countryCode: String): Int {
    ...
    ).takeIf { it != 0 } ?: R.drawable.placeholder // Usar un recurso genérico si no existe
}
